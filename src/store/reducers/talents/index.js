...
export const TalentsActions = {
    SET_TALENTS_VALUE: "SET_TALENTS_VALUE",
    SET_TALENTS_MAX : "SET_TALENTS_MAX",
    SET_TALENTS_MIN : "SET_TALENTS_MIN",
    SET_TALENTS_AVG : "SET_TALENTS_AVG",
    SET_IS_TALENTS_CALCULATING: "SET_IS_TALENTS_CALCULATING",
    SET_TALENTS_POINTS: "SET_TALENTS_POINTS",
}

export default function talentsReducer (state = initialState, action) {
    switch (action.type) {
        case TalentsActions.SET_TALENTS_VALUE:
        ...
        case TalentsActions.SET_TALENTS_MAX:
            return {
                ...state, 
        ...
        case TalentsActions.SET_TALENTS_MIN:
            return {
                ...state, 
        ...
        case TalentsActions.SET_TALENTS_AVG:
            return {
                ...state, 
