...
const DATA_INTIMICY_TITLE = {
    ...
    "eng": {title: 'Intimicy Calculation', subtitle: 'Interserver Intimicy Rating (O Malley)'},
    "tur": {title: 'Yakınlık Hesabı', subtitle: 'Sunucular Arası Yakınlık Derecesi (O Malley)'},
}
